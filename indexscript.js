...
function runAway() {
    ...
    // Hacer el botón Sí más atractivo
    ...
    if (runAwayCount === 15) {
        noBtn.textContent = "Está bien 😅";
    }
    if (runAwayCount === 20) {
        noBtn.textContent = "Vale, vale 🏳️";
    }
}
